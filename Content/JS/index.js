...
//-------------------------------------------------------------------------------------------------VV aqui
  ...
  //image.src = 'Content/IMG/pug.png';
  //image.src = 'http://mirante.mirahomologacao.com.br/Images/Mira_Preto_Transparente.png';
  image.src = 'Content/IMG/avatar.png';
...
Platform.prototype.draw = function() {
  ...
  image.src = 'Content/IMG/predio3.png';
  InfiniteRunner.drawImage(image, this.x, this.y, this.width, this.height);

  /** MATIZ */
  InfiniteRunner.globalCompositeOperation = "source-atop";
  InfiniteRunner.globalAlpha = 0.5; // you may want to make this an argument
  InfiniteRunner.fillStyle   = this.color;
  InfiniteRunner.fillRect(this.x, this.y, this.width, this.height);
  // reset
  InfiniteRunner.globalCompositeOperation = "source-over";
  InfiniteRunner.globalAlpha = 1.0;
...
PlatformManager.prototype.updateWhenLose = function() {
  console.log('Callback - Perdeu 1 vida');
  this.first.x = 300;
  this.first.color = randomChoice(this.colors);
